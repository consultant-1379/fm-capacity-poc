...
public final class AlarmProcessorConstants {
    ...
    public static final String DELETE_NETWORK_ELEMENT_PROBLEM_TEXT = "Deleted the Stateless alarm from the Open Alarm DB as as corresponding NetworkElement is deleted.";
    public static final String CLEAR_UNCORRELATED_PROBLEM_TEXT = "This alarm is generated by AlarmProcessor during synchronization to Clear the Uncorrelated alarm";
    public static final String DELETE_DUPLICATE_ALARM_PROBLEM_DETAIL = "Deleted the duplicate alarm from the Open Alarm DB as it is duplicate of an existing alarm.";
    ...
    public static final int SLEEP_DURING_REMOVE = 10;
